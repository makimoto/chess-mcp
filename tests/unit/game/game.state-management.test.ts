...
import type { GameData } from '../../../src/types/game.types.js';
...
describe('Game State Management', () => {
  ...
  describe('completeGame', () => {
    ...
    it('should accept all valid game results', () => {
      ...
      const results: Array<'1-0' | '0-1' | '1/2-1/2'> = [
        '1-0',
        '0-1',
        '1/2-1/2',
      ];
  ...
  describe('pauseGame', () => {
    ...
    it('should throw error if trying to pause already paused game', () => {
      ...
      expect(() => game.pauseGame('player2')).toThrow('Game is already paused');
    });
  });
  ...
  describe('resumeGame', () => {
    ...
    it('should throw error if game not paused', () => {
      expect(() => game.resumeGame()).toThrow('Game is not paused');
    });

    it('should throw error if trying to resume completed game', () => {
      game.completeGame('1-0');

      expect(() => game.resumeGame()).toThrow('Cannot resume completed game');
    });
  });
