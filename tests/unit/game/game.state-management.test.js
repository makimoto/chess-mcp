...
describe('Game State Management', () => {
    ...
    describe('completeGame', () => {
        it('should mark game as completed with result', () => {
            ...
            expect(game.updatedAt.getTime()).toBeGreaterThanOrEqual(beforeUpdate.getTime());
        });
        it('should throw error if game already completed', () => {
            game.completeGame('1-0');
            expect(() => game.completeGame('0-1')).toThrow('Game is already completed');
        });
    ...
    describe('pauseGame', () => {
        ...
        it('should throw error if game not active', () => {
            game.completeGame('1-0');
            expect(() => game.pauseGame('player1')).toThrow('Can only pause active games');
        });
        it('should throw error if trying to pause already paused game', () => {
            game.pauseGame('player1');
            expect(() => game.pauseGame('player2')).toThrow('Can only pause active games');
        });
    });
    describe('resumeGame', () => {
    ...
    describe('serialization', () => {
        it('should serialize to JSON correctly', () => {
            ...
            expect(json.fen).toBe('rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1');
    ...
    describe('deserialization', () => {
        ...
        it('should deserialize game with custom FEN position', () => {
            ...
            expect(restored.fen).toBe('rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq - 0 1');
