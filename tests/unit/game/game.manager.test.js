...
describe('GameManager', () => {
    ...
    describe('Game Creation', () => {
        ...
        it('should return list of active games', async () => {
            ...
            expect(activeGames.map(g => g.id).sort()).toEqual([game1.id, game2.id].sort());
        });
    });
    ...
    describe('Game Listing', () => {
        it('should return all games including completed ones', async () => {
            ...
            expect(allGames.map(g => g.id).sort()).toEqual([game1.id, game2.id].sort());
        });
        it('should return only completed games', async () => {
            ...
            expect(completedGames.map(g => g.id).sort()).toEqual([game1.id, game2.id].sort());
    ...
    describe('New Storage Methods', () => {
        ...
        it('should get player games', async () => {
            ...
            expect(player1Games.map(g => g.id).sort()).toEqual([game1.id, game2.id].sort());
        });
