...
import {
  ...
  TEST_TIME_CONTROLS,
  createTestGame,
  expectBasicGameProperties,
  expectInitialGameState,
  expectTimeControlInitialization,
  expectUniqueGameIds,
...
describe('Game Creation', () => {
  describe('when creating a new game with two players', () => {
    ...
    it('should assign players correctly', () => {
      const game = createTestGame(
        TEST_PLAYERS.AGGRESSIVE_PLAYER,
        TEST_PLAYERS.DEFENSIVE_PLAYER
      );
      expectBasicGameProperties(
        game,
        TEST_PLAYERS.AGGRESSIVE_PLAYER,
  ...
  describe('time control', () => {
    ...
    it('should not set time remaining when time control has no initial time', () => {
      const game = createTestGame(
        TEST_PLAYERS.WHITE_PLAYER,
        TEST_PLAYERS.BLACK_PLAYER,
        TEST_TIME_CONTROLS.INCREMENT_ONLY
      );
