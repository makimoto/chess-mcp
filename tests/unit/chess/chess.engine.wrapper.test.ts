...
describe('ChessEngine (Wrapper Functionality)', () => {
  ...
  beforeEach(() => {
    ...
    mockChess = engine.getChessInstance() as jest.Mocked<Chess>;
  });
  ...
  describe('API Unification', () => {
    it('should handle coordinate notation for move validation', () => {
      const mockMoves: Move[] = [{ to: 'e4', from: 'e2' } as Move];
    ...
    it('should handle algebraic notation for move validation', () => {
      const mockMoves = ['e4', 'Nf3'] as string[];
      (
        mockChess.moves as jest.MockedFunction<typeof mockChess.moves>
      ).mockReturnValue(mockMoves as unknown as Move[]);
    ...
    it('should handle coordinate notation for move execution', () => {
      mockChess.move.mockReturnValue({ san: 'e4' } as Move);
  ...
  describe('Null/Undefined Normalization', () => {
    ...
    it('should return false when chess.js move returns null', () => {
      mockChess.move.mockReturnValue(null as unknown as Move);
    ...
    it('should return true when chess.js undo succeeds', () => {
      mockChess.undo.mockReturnValue({ san: 'e4' } as Move);
    ...
    it('should return piece when chess.js get returns piece', () => {
      const mockPiece: Piece = { type: 'p', color: 'w' };
    ...
    it('should return null when chess.js get returns null', () => {
      mockChess.get.mockReturnValue(null as unknown as Piece | undefined);
