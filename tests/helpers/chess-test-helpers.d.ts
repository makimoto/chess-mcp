 ...
 */
export declare function expectValidMoves(engine: ChessEngine, moves: string[]): void;
/**
 * Helper to test invalid move patterns
 */
export declare function expectInvalidMoves(engine: ChessEngine, moves: string[]): void;
/**
 ...
 */
export declare function expectMoveChangesPosition(engine: ChessEngine, move: string | [string, string]): void;
/**
 * Helper to test that an invalid move doesn't change position
 */
export declare function expectMoveDoesNotChangePosition(engine: ChessEngine, move: string | [string, string]): void;
/**
 * Helper to verify game state detection
 */
export declare function expectGameState(engine: ChessEngine, expectations: {
    isGameOver?: boolean;
    isCheckmate?: boolean;
    isStalemate?: boolean;
    isCheck?: boolean;
 ...
 */
export declare function expectPieceAt(engine: ChessEngine, square: string, expectedPiece: {
    type: string;
    color: string;
} | null): void;
/**
 ...
 */
export declare function expectMoveHistory(engine: ChessEngine, expectedLength: number, expectedMoves?: string[]): void;
/**
 * Helper to test performance requirements
 */
export declare function expectPerformance(operation: () => void, maxTimeMs: number, iterations?: number): void;
