...
export const TEST_TIME_CONTROLS = {
  BLITZ: { type: 'fischer', initialTime: 300000, increment: 3000 }, // 5 min + 3 sec
  RAPID: { type: 'fischer', initialTime: 600000, increment: 5000 }, // 10 min + 5 sec
  CLASSICAL: { type: 'fischer', initialTime: 1800000, increment: 30000 }, // 30 min + 30 sec
  INCREMENT_ONLY: { type: 'fischer', increment: 5000 },
} as const;
